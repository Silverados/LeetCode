...
public class LeetCode874 {
    ...
    /**
     * 判断朝向 起始面北 根据接收向左或向右的命令判断朝向 为便于计算 将向左定义为 1，向右定义为-1 计算和
     *
     * @param commands
     * @param obstacles
     * @return
    ...
    public static int robotSim(int[] commands, int[][] obstacles) {
        ...
        for (int command : commands) {
            ...
            result = (int) Math.max((Math.pow(x, 2) + Math.pow(y, 2)), result);
        }
        return result;
    }
}
